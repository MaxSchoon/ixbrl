...
- **EDGAR 25.2 / 2026 Taxonomies Updates**: annual taxonomy refreshes became loadable in EDGAR through 2025 and 2026 (US-GAAP and SRT 2025 at Release 25.1; US-GAAP, SRT and DEI 2026 at Release 26.1; a submission uses one year's set throughout). Filers transitioning concept usage should re-map extensions onto the new base elements where one is available and appropriate; anchoring arcs remain optional (see *Custom (extension) elements*).
