---
name: ixbrl
description: Use when the user is preparing, reviewing, validating, or debugging Inline XBRL (iXBRL) or XBRL filings — for any regulator (SEC EDGAR, ESMA ESEF, UK FRC / Companies House / HMRC, Dutch SBR / KvK / AFM, EBA COREP/FINREP, EIOPA Solvency II, IFRS Foundation taxonomy, FASB US-GAAP, EDINET, MCA). Use whenever the user mentions Inline XBRL, iXBRL, XBRL, ESEF, anchoring, extension taxonomy, EDGAR Filer Manual, EFM error code, ESEF.* code, calc linkbase, calculation inconsistency, fact tagging, decimals, contextRef, unitRef, ix:nonFraction, ix:nonNumeric, ix:hidden, transformation registry, taxonomy package, report package, Arelle, EDINET, KvK iXBRL deposit, SBR, NT taxonomy, COREP, FINREP, DPM, Solvency II XBRL, Pay-Versus-Performance tagging, block tagging, narrative tagging, or annual financial report digital format. Also use whenever the user asks for help mapping line items to taxonomy concepts, building or auditing an extension taxonomy, deciding instant vs duration period type, choosing transformation formats, fixing FR-NL-* / EFM.6.* / ESEF.* / xbrldie:* / xbrl.5.2.5.2 errors, generating a taxonomy package or report package, computing balance/sign conventions, or running validation through Arelle.
---
